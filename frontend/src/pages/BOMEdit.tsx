...
import type { BOM, Product, WorkCenter } from '../types';
...
export const BOMEdit = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        const [bomResponse, productsResponse, workCentersResponse] = await Promise.all([
          apiService.getBOM(id),
        ...
        setFormData({
          name: bomData.name,
          productId: bomData.product.id,
          version: bomData.version,
          isActive: bomData.isActive,
          description: bomData.description || ''
        });
        
        // Convert BOM components and operations to editable format
        setComponents(bomData.components?.map(comp => ({
          id: comp.id,
        ...
        setOperations(bomData.operations?.map(op => ({
          id: op.id,
          workCenterId: op.workCenter.id,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiService.updateBOM(id, bomData);
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-muted-foreground mb-4">
          The BOM you're trying to edit doesn't exist or has been deleted.
        </p>
        <Button asChild>
          <Link to="/bom">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" onClick={() => navigate(`/bom/${id}`)}>
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Update BOM details, components, and operations
          </p>
        </div>
      </div>
          ...
          <TabsContent value="basic" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update the basic details for the BOM
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="components" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage components and materials required for this BOM
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <TabsContent value="operations" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage manufacturing operations and work centers
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
          ...
          <TabsContent value="summary" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review the updated BOM details and cost breakdown
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
